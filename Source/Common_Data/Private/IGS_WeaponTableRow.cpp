...
FIGS_WeaponTableRow::FIGS_WeaponTableRow() {
    ...
    auto& gen1970 = (*TBaseStructure<FGameplayTagContainer>::Get()->FindPropertyByName("GameplayTags")->ContainerPtrToValuePtr<TArray<FGameplayTag>>(&(*this).WieldableData.GrantedTags, 0));
    gen1970.Empty();
    auto& gen1971 = (*TBaseStructure<FGameplayTagContainer>::Get()->FindPropertyByName("ParentTags")->ContainerPtrToValuePtr<TArray<FGameplayTag>>(&(*this).WieldableData.GrantedTags, 0));
    gen1971.Empty();
    auto& gen1972 = (*this).WieldableData.GrantedAbilities;
    gen1972.Empty();
    auto& gen1973 = (*this).WieldableData.AppliedEffects;
    gen1973.Empty();
    ...
    auto& gen1974 = (*this).WieldableData.AdditionalPreloadClasses;
    gen1974.Empty();
    auto& gen1975 = (*this).WieldableData.AdditionalPreloadObjects;
    gen1975.Empty();
