...
void UMETA_EventFunctionLibrary::FromPlotlineGraphsData(const TArray<FIGS_PlotlineGraphData>& PlotlineGraphs, TArray<TSoftObjectPtr<UStoryGraphManager>>& outPlotlineGraphs) {
}
