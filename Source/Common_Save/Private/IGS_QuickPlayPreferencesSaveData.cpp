...
FIGS_QuickPlayPreferencesSaveData::FIGS_QuickPlayPreferencesSaveData() {
    ...
    auto& gen2135 = (*TBaseStructure<FUniqueNetIdRepl>::Get()->FindPropertyByName("ReplicationBytes")->ContainerPtrToValuePtr<TArray<uint8>>(&(*this).PlayerHeisterData.UniquePlayerId, 0));
    gen2135.Empty();
    ...
    auto& gen2136 = (*this).PlayerHeisterData.Loadout.Equipment;
    gen2136.Empty();
    auto& gen2137 = (*this).PlayerHeisterData.Loadout.Perks;
    gen2137.Empty();
