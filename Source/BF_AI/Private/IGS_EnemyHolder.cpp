...
FIGS_EnemyHolder::FIGS_EnemyHolder() {
    ...
    (*this).AggroHolder.TotalDamage = 0.000000000e+00f;
    (*this).AggroHolder.LastDamage = 0.000000000e+00f;
    (*this).AggroHolder.Distance = 0.000000000e+00f;
    (*this).AggroHolder.NormalizedDistance = 0.000000000e+00f;
