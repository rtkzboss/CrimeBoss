...
UIGS_StealthSettings::UIGS_StealthSettings() {
    ...
    auto& gen628 = (*this).DistanceDetectionSpeedCurve.EditorCurveData.Keys;
    gen628.Empty();
    gen628.AddDefaulted(3);
    ...
    auto& gen629 = (*this).AngleDetectionSpeedCurve.EditorCurveData.Keys;
    gen629.Empty();
    gen629.AddDefaulted(3);
