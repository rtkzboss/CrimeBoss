...
UIGS_AISecondaryWeaponDef::UIGS_AISecondaryWeaponDef() {
    ...
    (*TBaseStructure<FGameplayTag>::Get()->FindPropertyByName("TagName")->ContainerPtrToValuePtr<FName>(&(*this).Weapon.WeaponTag, 0)) = TEXT("Item.Wieldable.Weapon.SecondaryWeapon");
}
