...
FIGS_PlayerStateData::FIGS_PlayerStateData() {
    ...
    auto& gen3100 = (*TBaseStructure<FUniqueNetIdRepl>::Get()->FindPropertyByName("ReplicationBytes")->ContainerPtrToValuePtr<TArray<uint8>>(&(*this).HeisterDataHolder.UniquePlayerId, 0));
    gen3100.Empty();
    ...
    auto& gen3101 = (*this).HeisterDataHolder.Loadout.Equipment;
    gen3101.Empty();
    auto& gen3102 = (*this).HeisterDataHolder.Loadout.Perks;
    gen3102.Empty();
