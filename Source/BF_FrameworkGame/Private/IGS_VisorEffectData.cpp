...
FIGS_VisorEffectData::FIGS_VisorEffectData() {
    ...
    (*this).DrillSparksScale.Z = 5.000000000e-01f;
    (*this).DrillSparksDefaultRelativeOffset = -4.000000000e+01f;
    (*this).DrillSparksMaxViewAngleOffset = 4.000000000e+01f;
    (*this).MinDotToActivateSparks = 2.500000000e-01f;
    (*this).SparksSpawnRate = 1.500000000e+00f;
    (*this).SparksSpawnProbability = 7.500000000e-01f;
    (*this).SparksSpawnBoxRange.X = 0.000000000e+00f;
    (*this).SparksSpawnBoxRange.Y = 2.500000000e+01f;
    (*this).SparksSpawnBoxRange.Z = 2.500000000e+01f;
    (*this).NumberOfTextures = 6;
    (*this).MaximumFPS = 0.000000000e+00f;
    (*this).EffectPreventionChannel = ECC_GameTraceChannel13;
