...
FIGS_PlayerJoinInfo::FIGS_PlayerJoinInfo() {
    ...
    auto& gen3097 = (*TBaseStructure<FUniqueNetIdRepl>::Get()->FindPropertyByName("ReplicationBytes")->ContainerPtrToValuePtr<TArray<uint8>>(&(*this).CachedHeisterData.UniquePlayerId, 0));
    gen3097.Empty();
    ...
    auto& gen3098 = (*this).CachedHeisterData.Loadout.Equipment;
    gen3098.Empty();
    auto& gen3099 = (*this).CachedHeisterData.Loadout.Perks;
    gen3099.Empty();
