...
UMETA_TurfWarData::UMETA_TurfWarData() {
    ...
    (*this).NumberOfEnemySoldiersMultiplier = 2.000000000e+00f;
    (*this).ArmyTierMultiplier_IfEnemyTierHigherThanPlayers = 1.000000000e+00f;
    (*this).ArmyTierMultiplier_IfEnemyTierLowerThanPlayers = 1.000000000e+00f;
